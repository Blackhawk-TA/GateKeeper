...
namespace game {
	Scene::Scene(const SceneOptions& options) {
		...
		flags::set_flags(flags::TileFlags::WALKABLE, {
			33, 40, 41, 42, 68, 69, 70, 71, 97, 104, 105, 106, 133, 134, 135, 161, 168, 169, 170, 197, 198, 199, 261, 262, 263, 325, 326, 327, 640, 641, 689, 690, 691, 705, 712, 713,
			753, 754, 755, 769, 776, 817, 818, 819, 840, 841, 968, 1029, 1030, 1037, 1038, 1093, 1094, 1101, 1102, 1157, 1158, 1159, 1165, 1166, 1167,
