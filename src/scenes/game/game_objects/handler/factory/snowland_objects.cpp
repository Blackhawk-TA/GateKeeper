...
namespace game::game_objects {
	std::vector<GameObject*> create_snowland_objects(uint8_t save_id, StoryState story_state) {
		return {
			...
			new Enemy(map::SNOWLAND, Point(18, 46), 4, ICE_BEAR, UP, save_id, true, "GRR!"),
			new Enemy(map::SNOWLAND, Point(42, 29), 4, ICE_BEAR, LEFT, save_id, true, "GRR!"),
			new Enemy(map::SNOWLAND, Point(57, 33), 4, ICE_BEAR, UP, save_id, true, "GRR!"),
			new Enemy(map::SNOWLAND, Point(42, 5), 4, ICE_BEAR, UP, save_id, true, "GRR!"),
			new Enemy(map::SNOWLAND, Point(54, 19), 4, ICE_BEAR, UP, save_id, true, "GRR!"),
