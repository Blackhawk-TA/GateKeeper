...
Listbox::Item items::create_combat_attack_sword(uint8_t type_id, combat::Player *player, combat::Enemy *enemy) {
	return Listbox::Item{
		type_id,
		"SWORD",
		...
		0,
		[player, enemy] {
			if (combat::character_handler::attack(GEAR_SWORD, player, enemy)) {
